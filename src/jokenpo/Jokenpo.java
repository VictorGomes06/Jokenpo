		...
		while (escolha.equalsIgnoreCase("s")) {
			...
			while (contador < quantidadeRodadas) {
				while (quantidadeRodadas % 2 == 0 || quantidadeRodadas < 3) {
					System.out.println("Por favor n�o digite n�meros pares ou menores que 3!");
					System.out.println();
				...
				while (quantidadeRodadas != rodadas) {
					System.out.println("Escolha um valor de 1 at� 3: ");
					System.out.println("");
				...
				if ((jogador == 1 && maquina == 3) || (jogador == 2 && maquina == 1)
						|| (jogador == 3 && maquina == 2)) {
					System.out.println("Voc� ganhou essa rodada!!");
					System.out.println("");

				} else if ((jogador == 1 && maquina == 2) || (jogador == 2 && maquina == 3)
						|| (jogador == 3 && maquina == 1)) {
			...
			if (vitoriaJogador > vitoriaMaquina) {
				System.out.println("***** Voc� ganhou meu cria *****");
			} else {
				System.out.println("***** O computador ganhou *****");
			}
			System.out.println("");

			System.out.print("Voc� deseja jogar mais? S/N");
			System.out.print("");
			escolha = ler.next();

		}
		while (!escolha.equalsIgnoreCase("s") && !escolha.equalsIgnoreCase("n")) {
			System.out.println("Por favor digite S caso queira continuar jogando e N caso n�o queira jogar mais !!!");
			System.out.println();
			escolha = ler.next();
